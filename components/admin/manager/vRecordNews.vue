    ...
    <tr class="w-full overflow-scroll">
        ...
        <td class="lg:w-52 w-16">
            <div class="flex lg:flex-row flex-col">
                ...
                <NewsVEdit :data="ModalEdit" @save="edit" :loading="isLoading" />
...
const ModalEdit = ref({
    ...
    avatar: computed(() => { return props.data.image })
})

const edit = async (data, close) => {
    try {
        isLoading.value = true
        await useNews.update(props.data._id, data);
        emit('refreshData')
...
const deleteOne = async () => {
    try {
        ...
        await useNews.deleteOne(props.data._id)
        emit('refreshData')
