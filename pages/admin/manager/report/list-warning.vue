<template>
    <div class="">
        ...
        <OtherVTable :is-user="false" class="" v-show="!isLoading" :refresh-cb="refreshData" :list-title="listTitle"
            :list-data="[...listData]" :cpn="AdminManagerVRecordWarning" />
...
<script setup>
import AdminManagerVRecordWarning from '~~/components/admin/manager/vRecordWarning';
...
const getMore = async (page, limit) => {
    try {
        ...
        const result = await useStatusComment.findAllWarning(page, limit);
