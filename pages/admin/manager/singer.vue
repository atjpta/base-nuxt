<template>
    <div class="">
        ...
        <div class="flex justify-between my-3">
            <OtherVSearch id="search-singer-admin" @search="search" />
        ...
        <OtherVTable class="" v-show="!isLoading" :refresh-cb="refreshData" :list-title="listTitle"
            :list-data="[...listData]" :cpn="AdminManagerVRecordSinger" />
...
<script setup>
import AdminManagerVRecordSinger from '~~/components/admin/manager/vRecordSinger';
